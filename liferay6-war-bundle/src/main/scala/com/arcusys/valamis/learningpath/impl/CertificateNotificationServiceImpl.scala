...
import com.liferay.portal.service.{CompanyLocalServiceUtil, UserLocalServiceUtil}
...
class CertificateNotificationServiceImpl(val emailNotificationHelper: EmailNotificationHelperService,
                                        ...
                                        (implicit val executionContext: ExecutionContext) extends CertificateNotificationService {
