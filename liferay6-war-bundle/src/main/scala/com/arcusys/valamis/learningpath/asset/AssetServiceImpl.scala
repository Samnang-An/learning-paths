...
import com.liferay.portal.kernel.search.{IndexerRegistryUtil, SearchEngineUtil}
import com.liferay.portal.kernel.util.ContentTypes
import com.liferay.portal.service.{ClassNameLocalServiceUtil, CompanyLocalServiceUtil, UserLocalServiceUtil}
...
class AssetServiceImpl
  ...
  private def updateIndex(learningPath: LearningPath,
    ...
    Option(IndexerRegistryUtil.getIndexer(LPClassName)) match {
